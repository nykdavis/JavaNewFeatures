...
public class MapPractice {
	...
	public static void main(String[] args) {
		...
		// Problem 1:Given a list of strings, find the lengths of each string in the
		// list.
		...
		// Problem 2: Given a list of integers, find the square of each integer in the
		// list.
		...
		list1.stream().map(i -> i * i).forEach(value -> System.out.print(value+" "));
		...
		// Problem 4:Given a list of strings, extract the first character of each
		// string.
